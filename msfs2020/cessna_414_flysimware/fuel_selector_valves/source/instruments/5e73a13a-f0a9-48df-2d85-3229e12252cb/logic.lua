...
function right_left_main()
    ...
    fs2020_event("FUEL_SELECTOR_2_RIGHT_MAIN")
end
right_left_btn = button_add(nil, nil, 566, 38, 180, 180, right_left_main)

-- Left Tank
function right_right_main()
    fs2020_variable_write("L:FUEL_Lever_Selector_2", "Enum",0)
    fs2020_event("FUEL_SELECTOR_2_LEFT_MAIN")
end
right_right_btn = button_add(nil, nil, 387, 38, 180, 180, right_right_main)

--Off
function right_off_main()
    fs2020_variable_write("L:FUEL_Lever_Selector_2", "Enum", 2)
    fs2020_event("FUEL_SELECTOR_2_OFF")
end
