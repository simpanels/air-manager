...
--******************************************************************************************
    ...
    V1.02 - Released 2022-03-12
        - Updated for Kodiak 1.0.24
        - Ignition switch now animates in virtual cockpit
...
function ignition_click_callback(position)
    if position == 0 then
        ...
        fs2020_variable_write("L:SWS_Engine_Switch_Ignition_1", "Number", 1)
    else
        switch_set_position(ignition_switch_id, 0)
        fs2020_variable_write("L:SWS_Engine_Switch_Ignition_1", "Number", 0)
    end
end
...
fs2020_variable_subscribe("L:SWS_Engine_Switch_Ignition_1", "Number", new_ignition_pos)
