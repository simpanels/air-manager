...
sw_lights_glareshield = switch_add(nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil, 950, 92, 95,95, callback_lights_glareshield)
...
sw_lights_instruments = switch_add(nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,  958,100,81,81, callback_lights_instruments)
...
sw_lights_panel = switch_add(nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil,nil, 1084,100,81,81, callback_lights_panel)
