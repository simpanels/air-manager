...
button_add("softkey.png","softkey_pressed.png", 1060,273,112,77, sc_1_click)

function sc_2_click()
    fs2020_event("H:AS3000_TSC_Horizontal_" .. bezel_pos .. "_SoftKey_2")
    sound_play(click_snd)
end
button_add("softkey.png","softkey_pressed.png", 1060,358,112,77, sc_2_click)

function sc_3_click()
    fs2020_event("H:AS3000_TSC_Horizontal_" .. bezel_pos .. "_SoftKey_3")
    sound_play(click_snd)
end
button_add("softkey.png","softkey_pressed.png", 1060,441,112,77, sc_3_click)
